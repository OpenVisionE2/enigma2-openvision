...
void bsodFatal(const char *component)
{
	...
	char backgroundcolor = eConfigManager::getConfigIntValue("config.crash.backgroundcolor");
	char foregroundcolor = eConfigManager::getConfigIntValue("config.crash.foregroundcolor");
