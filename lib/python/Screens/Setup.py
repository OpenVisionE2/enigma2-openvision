...
class Setup(ConfigListScreen, Screen, HelpableScreen):
	...
	<screen name="Setup" position="center,center" size="980,570" resolution="1280,720">
		...
		<widget name="footnote" position="10,e-185" size="e-20,25" font="Regular;20" verticalAlignment="center" />
		<widget name="description" position="10,e-160" size="e-20,100" font="Regular;20" verticalAlignment="center" />
		...
		<widget source="key_menu" render="Label" position="e-400,e-50" size="90,40" backgroundColor="key_back" conditional="key_menu" font="Regular;20" foregroundColor="key_text" horizontalAlignment="center" verticalAlignment="center">
			<convert type="ConditionalShowHide" />
		</widget>
		<widget source="key_info" render="Label" position="e-300,e-50" size="90,40" backgroundColor="key_back" conditional="key_info" font="Regular;20" foregroundColor="key_text" horizontalAlignment="center" verticalAlignment="center">
			<convert type="ConditionalShowHide" />
		</widget>
		<widget source="VKeyIcon" text="TEXT" render="Label" position="e-200,e-50" size="90,40" backgroundColor="key_back" conditional="VKeyIcon" font="Regular;20" foregroundColor="key_text" horizontalAlignment="center" verticalAlignment="center">
			<convert type="ConditionalShowHide" />
		</widget>
