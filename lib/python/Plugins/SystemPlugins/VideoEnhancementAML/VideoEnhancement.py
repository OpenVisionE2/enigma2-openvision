...
class VideoEnhancement:
	...
	def createConfig(self, *args):
		...
		if isfile("/sys/class/amvecm/contrast1"):
			def setContrast1(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write video contrast.")
		...
		if isfile("/sys/class/amvecm/contrast2"):
			def setContrast2(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write video & OSD contrast.")
		...
		if isfile("/sys/class/amvecm/saturation_hue_post"):
			def setSaturation(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write saturaion.")
		...
		if isfile("/sys/class/amvecm/saturation_hue"):
			def setHue(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write hue.")
		...
		if isfile("/sys/class/amvecm/brightness1"):
			def setBrightness1(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write brightness1.")
		...
		if isfile("/sys/class/amvecm/brightness2"):
			def setBrightness2(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write brightness2.")
		...
		if isfile("/sys/class/amvecm/color_bottom"):
			def setColor_bottom(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write color button.")
		...
		if isfile("/sys/class/amvecm/color_top"):
			def setColor_top(config):
				...
				try:
					...
					print("[VideoEnhancement] couldn't write color top.")
