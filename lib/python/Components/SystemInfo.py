...
SystemInfo["HasFullHDSkinSupport"] = model not in ("et4x00","et5x00","sh1","hd500c","hd1100","xp1000","lc") and brand not in ("mecool","minix","hardkernel")
...
SystemInfo["canMultiBoot"] = SystemInfo["HasRootSubdir"] and (1, 4, "mmcblk0", False) or "%s_4.boxmode" % model in cmdline and (1, 4, "mmcblk0", False) or model in ("gbue4k","gbquad4k","gbx34k") and (3, 3, "mmcblk0", True) or model == "e4hdultra" and (1, 4, "mmcblk0", False) or model in ("osmio4k","osmio4kplus","osmini4k") and (1, 4, "mmcblk1", True)
...
SystemInfo["CanFadeOut"] = brand not in ("linkdroid","mecool","minix","wetek","hardkernel") and model not in ("gbtrio4k","gbip4k","sf8008","cc1","ustym4kpro","beyonwizv2","viper4k","dreamone") and not pathExists("/proc/hisi") and not fileExists("/usr/bin/hihalt")
...
SystemInfo["HiSilicon"] = model in ("gbtrio4k","gbip4k","sf8008","cc1","ustym4kpro","beyonwizv2","viper4k") or pathExists("/proc/hisi") or fileExists("/usr/bin/hihalt")
