from enigma import eDVBResourceManager, Misc_Options, eDVBCIInterfaces, getBoxType
...
SystemInfo["HasExternalPIP"] = not (HardwareInfo().get_device_model().startswith("et9") or HardwareInfo().get_device_model().startswith("et5") or HardwareInfo().get_device_model().startswith("et6")) and fileCheck("/proc/stb/vmpeg/1/external")
SystemInfo["VideoDestinationConfigurable"] = fileExists("/proc/stb/vmpeg/0/dst_left")
SystemInfo["hasPIPVisibleProc"] = fileCheck("/proc/stb/vmpeg/1/visible")
SystemInfo["MaxPIPSize"] = HardwareInfo().get_device_model() in ("hd51","h7","vs1500","e4hdultra") and (360, 288) or (540, 432)
...
SystemInfo["HasFullHDSkinSupport"] = HardwareInfo().get_device_model() not in ("et4000","et5000","sh1","hd500c","hd1100","xp1000","lc","k1plus","k1pro","k2pro","k2prov2","k3pro")
SystemInfo["HasBypassEdidChecking"] = fileCheck("/proc/stb/hdmi/bypass_edid_checking")
SystemInfo["HasColorspace"] = fileCheck("/proc/stb/video/hdmi_colorspace")
SystemInfo["HasColorspaceSimple"] = SystemInfo["HasColorspace"] and HardwareInfo().get_device_model() in ("vusolo4k","vuuno4k","vuuno4kse","vuultimo4k","vuduo4k")
...
SystemInfo["canMultiBoot"] = HardwareInfo().get_device_model() in ("hd51","h7","vs1500","e4hdultra","protek4k") and (1, 4, "mmcblk0", False) or HardwareInfo().get_device_model() in ("gbue4k","gbquad4k") and (3, 3, "mmcblk0", True) or HardwareInfo().get_device_model() in ("osmio4k") and (1, 4, "mmcblk1", True)
...
SystemInfo["AmlogicFamily"] = getBoxType() in ("alien5","c300","c300pro","c400plus","k1plus","k1pro","k2pro","k2prov2","k3pro","kvim2","x8hp","odroidc2","wetekhub","wetekplay","wetekplay2")
SystemInfo["VFDDelay"] = getBoxType() in ("sf4008","beyonwizu4")
SystemInfo["VFDRepeats"] = getBoxType() not in ("ixussone","ixusszero","atemio6000","atemio6100","bwidowx2","mbhybrid","opticumtt","osmini","spycatmini","spycatminiplus","bwidowx","xpeedlx1","odinplus","xp1000","h3","h5","h6","sh1","9910lx","9911lx","9920lx","e4hdcombo","odin2hybrid","bre2ze","h4","h7","lc","vipercombohdd","evominiplus","enfinity","marvel1","vipercombo","formuler3","formuler4","hd1100","hd1200","hd1265","hd1500","hd500c","hd530c","vs1000","classm","axodin","axodinc","starsatlx","genius","evo","galaxym6","9900lx","tiviarmin","t2cable","xcombo","enibox","mago","x1plus","sf108","anadol4k","anadol4kcombo","anadol4kv2","axashis4kcombo","axashis4kcomboplus","dinobot4k","dinobot4kl","dinobot4kmini","dinobot4kplus","dinobot4kpro","dinobot4kse","dinobotu55","ferguson4k","mediabox4k","sf128","sf138","bre2zet2c","formuler4turbo","osninopro","osnino","osninoplus","osmio4k","hd60","hd61","h9combo","et1x000","bcm7358","vp7358ci","gbtrio4k","ustym4kpro","cc1","sf8008","beyonwizv2")
SystemInfo["HiSilicon"] = getBoxType() in ("gbtrio4k","sf8008","cc1","ustym4kpro","beyonwizv2")
SystemInfo["FirstCheckModel"] = getBoxType() in ("alien5","tmtwin4k","mbmicrov2","revo4k","force3uhd","wetekplay","wetekplay2","wetekhub","mbmicro","e4hd","e4hdhybrid","valalinux","lunix","tmnanom3","purehd","force2nano","purehdse")
SystemInfo["SecondCheckModel"] = getBoxType() in ("osninopro","osnino","osninoplus","ixussone","ixusszero","dm7020hd","dm7020hdv2","9910lx","9911lx","9920lx","tmnanose","tmnanoseplus","tmnanosem2","tmnanosem2plus","tmnanosecombo","force2plus","force2","force2se","optimussos","fusionhd","fusionhdse","force2plushv")
