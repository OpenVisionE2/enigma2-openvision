...
SystemInfo["MaxPIPSize"] = model == "h7" or platform in ("gfuturesbcmarm","8100s") and (360, 288) or (540, 432)
...
SystemInfo["LnbPowerAlwaysOn"] = model in ("vusolo4k","vuduo4k","vuultimo4k","vuuno4k","vuuno4kse") or platform == "gb7252"
