...
SystemInfo["HasFullHDSkinSupport"] = getBoxType() not in ("et4x00","et5x00","sh1","hd500c","hd1100","xp1000","lc") and getBoxBrand() not in ("mecool","minix","hardkernel")
...
SystemInfo["CanFadeOut"] = getBoxBrand() not in ("linkdroid","mecool","minix","wetek","hardkernel") and getBoxType() not in ("gbtrio4k","gbip4k","sf8008","cc1","ustym4kpro","beyonwizv2","viper4k","dreamone") and not pathExists("/proc/hisi") and not fileExists("/usr/bin/hihalt")
...
SystemInfo["ArchIsARM64"] = getBoxBrand() in ("linkdroid","mecool") or getBoxType() in ("wetekplay2","wetekhub","osmio4k","osmio4kplus","osmini4k","dreamone")
