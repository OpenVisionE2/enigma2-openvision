...
void eRTSPStreamClient::notifier(int what)
{
	...
	if (request.substr(0, 5) == "GET /")
	{
		...
		ss << "<manufacturer>" << modelinformation.getValue("brand") << "</manufacturer>";
		ss << "<manufacturerURL>https://openvision.tech</manufacturerURL>";
		ss << "<modelDescription>" << modelinformation.getValue("distro") << "</modelDescription>";
		ss << "<modelName>" << modelinformation.getValue("model") << "</modelName>";
		ss << "<modelNumber>1.1</modelNumber>";
		ss << "<modelURL>https://openvision.tech</modelURL>";
